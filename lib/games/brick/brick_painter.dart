...
///
/// 주요 로직 : 색만으로는 10종을 순간에 구분할 수 없다. **모양으로** 종류를 알아보게 한다.
///   (「도움=푸른·초록 / 방해=경고색」 으로 갈래를 색에 싣던 규칙은 2026-09-04 폐지 —
///    대비 색은 상반 개념(속도 ▼▲ · 패들 확대/축소)에만 쓴다)
///
///   1 ◉ 무적공   2 ◎ 멀티공   3 ▼ 속도감소   4 ◀▶ 패들확대
///   5~7 ■■ 벽돌생성(내구도 1·2·3)   8 ◐ 반전   9 ▶◀ 패들축소   10 ▲ 속도증가
